      ...
      <div style={S.card}>
        ...
        {sent ? (
          <>
            ...
            <p style={S.sub}>
              If an account is registered with <strong>{email}</strong>, we&apos;ve sent a
              password reset link. It expires in 2 hours.
            </p>
            <div style={S.note}>
              Didn&apos;t get it? Check your spam folder, or make sure you entered the email
              linked to your account.
            </div>
            <button style={S.submit} onClick={() => navigate("/login")}>
              Back to sign in
            </button>
            <button style={S.linkBtn} onClick={() => { setSent(false); setEmail(""); }}>
          ...
          <>
            ...
            <p style={S.sub}>
              Enter the email registered to your account and we&apos;ll send you a link to reset
              your password.
            </p>
            <form onSubmit={handleSubmit}>
              ...
              <input
                ...
                autoFocus
              />
              <button type="submit" style={S.submit} disabled={isLoading || !email.trim()}>
