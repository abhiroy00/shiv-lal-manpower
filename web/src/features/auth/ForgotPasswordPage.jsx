      ...
      <div style={S.card}>
        ...
        {sent ? (
          <>
            ...
            <p style={S.sub}>
              If <strong>{email}</strong> is registered to an admin account, we&apos;ve sent
              a password reset link. It expires in 2 hours.
            </p>
            <div style={S.note}>
              Didn&apos;t get it? Check spam, or make sure you used the email linked to your
              account.
            </div>
