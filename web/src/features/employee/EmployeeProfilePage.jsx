...
const S = {
  ...
  role:     { fontSize: 13, textTransform: "capitalize", marginBottom: 24, padding: "4px 14px", background: "#E3EEF9", borderRadius: 20, display: "inline-block", color: "#1565C0", fontWeight: 600 },
